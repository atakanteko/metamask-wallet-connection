...
export const Card = ({ connectMetamask, walletAddress }) => {
    return (
        <div className='bg-white rounded-md w-full h-fit shadow-custom xl:w-4/12'>
            ...
            <div className='bg-[#F2F4F7] px-8 py-6 border-t-2'>
                <button onClick={()=> connectMetamask()} className='bg-[#672CD0] w-full rounded-md py-2 text-center capitalize text-base text-white font-bold'>
                    connect wallet
                </button>
            </div>
        </div>
